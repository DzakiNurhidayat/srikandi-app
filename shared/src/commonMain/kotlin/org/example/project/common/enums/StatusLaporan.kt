...
enum class StatusLaporan(val label: String, val user: String, val ketua: String) {
    ...
    DONE(
        "Selesai",
        "Laporan Anda telah selesai diproses. Terima kasih atas laporan Anda. Setiap suara memiliki kekuatan, jangan takut untuk bersuara!",
        "Laporan sudah selesai. Silakan lakukan penutupan laporan"
    ),
}